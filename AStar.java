...
public class AStar {
    ...
    public boolean allowed8Directions = false;
    ...
    /** Method that set blocks by getting a 2D array of coordinates*/
    ...
    /** Method that returns the path as list*/
    ...
    /** Method that looks for all adjacent nodes*/
    ...
    /** Methods that cheks for adjacent edges on the lower row*/
    ...
    /** Methods that checks the adjacent nodes in the middle row*/
    ...
    /** Method that looks for adjacent nodes on the upper row*/
    ...
    /** Method to check the node and monitor its adjacent nodes*/
