/** UI Class containing methods that manipulates the interface*/
...
public class UI extends Application{
    ...
    /** An String array containing image paths*/
...
//                        currentPosRoadRunner[1] = newSartColumn;
    ...
    /** Method monitoring the reset functionality*/
    public void reset(){
        visited.clear();
        checkScore = 0;
    ...
    /** Method to check if the grid is visited
     * Time complexity: O(n)
     * Space Complexity: O(n)*/
    ...
    /** Method that replaces the image with its alternative*/
    ...
    /** Methods switches the road runner position*/
    ...
    /** Method to move up the road runner*/
    public void moveUp(){
    ...
    /** Method to undo towards recent activity
     * Time complexity: O(1)*/
    public void undo(){
    ...
    public ArrayList<String> astarPath(Node start, Node end){
        ...
        try{
            FileWriter file = new FileWriter("C:\\Users\\ALU Student 100\\IdeaProjects\\pp-ii-the-road-runner-alliance-mbonigaba-kevin-sebineza-alliance\\src\\Test Inputs\\Aliance_Kevin_Astar_Direction");
            file.write(message);
            file.close();
